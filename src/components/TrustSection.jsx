          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start gap-4 bg-surface-card p-4 rounded-lg shadow-sm">
      ...
      <section className="py-16 bg-surface-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <ul className="text-lg text-text-secondary space-y-2">
          ...
          <button
            ...
            className="bg-accent-butter hover:bg-accent-butterStrong text-brand-chocolate px-8 py-4 rounded-lg text-lg font-semibold transition-colors"
          >
            Fazer pedido agora
          </button>
        </div>
